...
fuente = CTkFont(family="Arial",size = 20)
...
caja3 = CTkLabel(app,text = f"temperatura : {temp}",font = fuente)
caja3.grid(row= 2,column = 0, padx = 5, pady= 5)

caja4 = CTkLabel(app,text = f"velocidad del viento : {viento}",font = fuente)
caja4.grid(row= 3,column = 0, padx = 5, pady= 5)


btn = CTkButton(app,text = "factos",command=factss)
